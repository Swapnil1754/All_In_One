(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var GoogleLoginProvider = /** @class */ (function (_super) {
                ...
                try {
                    _this.loadScript(GoogleLoginProvider.PROVIDER_ID, 'https://apis.google.com/js/api.js', function () {
                        gapi.load('client:auth2', function () {
                            gapi.client.init(Object.assign(Object.assign({}, _this.initOptions), { client_id: _this.clientId }))
                                .then(function () {
        ...
        GoogleLoginProvider.prototype.getLoginStatus = function (loginStatusOptions) {
            ...
            return new Promise(function (resolve, reject) {
                if (_this.auth2.isSignedIn.get()) {
                    ...
                    _this.setUserProfile(user_1, profile);
                    user_1.response = authResponse;
                    var resolveUser = function (authenticationResponse) {
                        user_1.authToken = authenticationResponse.access_token;
                        user_1.idToken = authenticationResponse.id_token;
                        resolve(user_1);
                    };
            ...
            return new Promise(function (resolve, reject) {
                ...
                promise
                    ...
                    if (response && response.code) {
                        ...
                        _this.setUserProfile(user, profile);
        ...
        GoogleLoginProvider.prototype.setUserProfile = function (user, profile) {
    ...
    SocialAuthService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: SocialAuthService, deps: [{ token: 'SocialAuthServiceConfig' }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    SocialAuthService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: SocialAuthService });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: SocialAuthService, decorators: [{
                type: i0.Injectable
    ...
    SocialLoginModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: SocialLoginModule, deps: [{ token: SocialLoginModule, optional: true, skipSelf: true }], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    SocialLoginModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: SocialLoginModule, imports: [common.CommonModule] });
    SocialLoginModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: SocialLoginModule, providers: [
            SocialAuthService
        ], imports: [[
                common.CommonModule
            ]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: SocialLoginModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [
                            common.CommonModule
